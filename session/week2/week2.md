...
git이 설치가 안되어 있다면 [여기](https://github.com/HYBLOCK-LAB/SOLiX)를 방문하여 zip파일로 다운받아주세요.
...
축하합니다! 성공적으로 License관련 컨트랙트를 작성하였습니다. 다음 시간에는 위원회 관련 컨트랙트 개발과 기존 컨트랙트에서 보안할 점을 채우도록 하겠습니다.
